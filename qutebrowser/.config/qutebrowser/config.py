...
# Allow locally loaded documents to access remote and local URLs.
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/laooree/.local/share/qutebrowser/userscripts/*')
config.set('content.local_content_can_access_file_urls', False, 'file:///home/laooree/.local/share/qutebrowser/userscripts/*')
